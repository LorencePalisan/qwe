...
import { ArrowLeft, Briefcase, Eye, EyeOff } from "@/icons";
...
export default function FreelanceAuth() {
      ...
      <div className="w-full max-w-[440px] rounded-[16px] border border-white/12 bg-white/10 p-8 backdrop-blur-sm">
        <div className="mb-8 flex items-center gap-2">
          <div className="flex size-8 items-center justify-center rounded-lg bg-[#F62C7D]/20">
            <Briefcase className="size-4 text-[#F62C7D]" />
          </div>
          <span className="text-[13.6px] font-medium text-[#F62C7D]">Freelance Account</span>
        </div>

        <h1 className="mb-2 text-[28px] font-bold text-white">Create your account</h1>
        <p className="mb-8 text-[14px] text-[#999]">Set up your freelance Whodini account</p>

        <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
          <div className="flex flex-col gap-2">
            <label className="text-[13.6px] font-medium text-white/80">Full Name</label>
            <input type="text" placeholder="Your professional name" className={INPUT} />
          </div>

          <div className="flex flex-col gap-2">
            <label className="text-[13.6px] font-medium text-white/80">Professional Email</label>
            <input type="email" placeholder="you@yourwork.com" className={INPUT} />
          </div>
